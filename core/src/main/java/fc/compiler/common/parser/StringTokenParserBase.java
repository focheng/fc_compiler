...
public class StringTokenParserBase implements StringTokenParser {
	@Override
	public AstNode parse(StringTokenReader reader, StringTokenParserRegistry registry) {
		throw new RuntimeException("Not Used/Implemented");
	}

	protected static <T> T syntaxError(StringTokenReader reader, String message) {
		log.error(message);
		return null;
	}

	protected static AstNode ignore(StringTokenReader reader, StringTokenParserRegistry registry) {
		reader.nextToken();
		return null;
	}

	public static <T extends AstNode> T parseGeneric(StringTokenReader reader, StringTokenParserRegistry registry) {
		StringToken token = reader.token();
		StringTokenParser<T> parser = registry.get(token.kind());
		if (parser != null) {
	...
	public static Statement parseStatement(StringTokenReader reader, StringTokenParserRegistry registry) {
		return parseGeneric(reader, registry);
	}


	public static CompositeStatement<Statement> parseCompositeStatement(StringTokenReader reader, StringTokenParserRegistry registry) {
	...
	public static Statement parseIfStatement(StringTokenReader reader, StringTokenParserRegistry registry) {
	...
	public static Statement parseForStatementCStyle(StringTokenReader reader, StringTokenParserRegistry registry) {
	...
	public static Statement parseVariableDeclaration(StringTokenReader reader, StringTokenParserRegistry registry) {
		throw new RuntimeException("Not implemented");
	}

	// == expressions ==

	public static Expression parseExpression(StringTokenReader reader, StringTokenParserRegistry registry) {
		return parseGeneric(reader, registry);
	}

	public static List<Expression> parseExpressionListZeroOrMore(StringTokenReader reader, StringTokenParserRegistry registry, String tokenKind) {
	...
	public static List<Expression> parseExpressionListOneOrMore(StringTokenReader reader, StringTokenParserRegistry registry,
	                                                            String tokenKind) {
		return parseExpressionListOneOrMore(reader, registry, tokenKind, StringTokenParserBase::parseExpression);
	}

	public static List<Expression> parseExpressionListOneOrMore(StringTokenReader reader, StringTokenParserRegistry registry,
	                                                            String separatorKind, StringTokenParser<Expression> exprParser) {
		List<Expression> list = new ArrayList<>();
		do {
	...
	public static CommaExpression parseCommaExpression(StringTokenReader reader, StringTokenParserRegistry registry) {
	...
	public static Expression parseAssignmentExpression(StringTokenReader reader, StringTokenParserRegistry registry) {
	...
	public static Expression parseTernaryExpression(StringTokenReader reader, StringTokenParserRegistry registry) {
	...
	public static Expression parseBinaryExpressionRest(StringTokenReader reader, StringTokenParserRegistry registry,
	...
	public static Expression parsePrefixUnaryExpression(StringTokenReader reader, StringTokenParserRegistry registry) {
	...
	public static Expression parsePostfixUnaryExpression(StringTokenReader reader, StringTokenParserRegistry registry, Expression expr) {
		for (;;) {
	...
	public static Expression parseTypeCast(StringTokenReader reader, StringTokenParserRegistry registry) {
	...
	public static Expression parseComponentSelection(StringTokenReader reader, StringTokenParserRegistry registry,
	                                                 Expression expr) {
		Identifier id = parseIdentifier(reader, registry);
		return new ComponentSelect().expression(expr).identifier(id);
	}

	public static Expression parseFunctionArguments(StringTokenReader reader, StringTokenParserRegistry registry,
	                                                Expression function) {
	...
	protected static Expression parseEnclosedExpression(StringTokenReader reader, StringTokenParserRegistry registry,
	                                                    String leftTokenKind, String rightTokenKind,
	                                                    StringTokenParser<Expression> parser) {
	...
	public static Identifier parseIdentifier(StringTokenReader reader, StringTokenParserRegistry registry) {
	...
	public static Literal parseLiteral(StringTokenReader reader, StringTokenParserRegistry registry) {
